...
<a href="<?php echo URLROOT; ?>/posts/show/<?php echo $data['id']; ?>" class="btn btn-light mt-5"> <i class="fas fa-backward mr-3"></i>Back</a>
<div class="card bg-light mt-5">
  <div class="card-header">
    <h2>Edit Post</h2>
    <p>Fill these fields to update your post</p>
  </div>
  <div class="card-body">
